namespace Lithium.Serialization
{
   ...
   // internal sealed class PrimitiveSchema : Schema
    ...
    internal sealed class ContainerSchema : Schema
    {
        ...
        private ContainerSchema(StructureType contaienerSchemaType, Type containerType) : base(contaienerSchemaType, containerType, false)
        {
            ...
            foreach (FieldInfo fieldInfo in fieldsInfo)
            {
                ...
                {
                    Log.Error($"Field \"{fieldInfo.FieldType} {fieldInfo.Name}\" from the {containerType} {contaienerSchemaType} will be ignored.");
                    continue;
                }
        ...
        public static void a<T>(T b) where T : struct { }
    }
    ...
    internal partial class Serialization
    {
        ...
        static readonly Dictionary<Type, Schema> schemas;
        ...
        private bool TryCreateSchema(Type type, out Schema? schema)
        {
        ...
        public bool TryGetSchema(Type type, out Schema? schema)
        {
